 ...
 * @covers     \aiprovider_groq\process_generate_image
...
final class process_generate_image_test extends \advanced_testcase {
    ...
    protected function setUp(): void {
        ...
        $this->responsebodyjson = file_get_contents(self::get_fixture_path('aiprovider_groq', 'image_request_success.json'));
    ...
    public function test_query_ai_api_success(): void {
        ...
        $mock->append(new Response(
            ...
            \GuzzleHttp\Psr7\Utils::streamFor(fopen(
                self::get_fixture_path('aiprovider_groq', 'test.jpg'),
                'r',
            )),
        ));
    ...
    public function test_process(): void {
        ...
        $mock->append(new Response(
            200,
            ['Content-Type' => 'image/jpeg'],
            \GuzzleHttp\Psr7\Utils::streamFor(fopen(self::get_fixture_path('aiprovider_groq', 'test.jpg'), 'r')),
        ));
